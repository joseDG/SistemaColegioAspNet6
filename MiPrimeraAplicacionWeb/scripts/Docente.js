...
function abrirModal(id) {
    ...
    if (id == 0) {
        ...
        voz("Agregando docente");
    } else {
        document.getElementById("lblTitulo").innerHTML = "Editando Docente";
        ...
        $.get("Docente/recuperarInformacion/?id=" + id, function (data) {
            ...
            var nombreCompelto = data[0].NOMBRE + " " + data[0].APPATERNO + " " + data[0].APMATERNO;
            voz("Editando docente "+nombreCompelto);
          ...
          $.ajax({
              ...
              success: function (data) {
                  if (data == 0) {
                      ...
                      alert("Ya existe el docente");
                      voz("Ya existe docente " + nombreCompleto);
                  }else
