window.onload = function () {
    voz("Bienvenido al formulario grado seccion aula");
}
...
function abrirModal(id) {
    ...
    if (id == 0) {
        borrarDatos();
        document.getElementById("lblTitulo").innerHTML = "Agregando Grado-Seccion-Aula";
        voz("Agregando Grado-Seccion-Aula");
    } else {
        document.getElementById("lblTitulo").innerHTML = "Editando Grado-Seccion-Aula";
        voz("Editando Grado-Seccion-Aula");
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == -1) {
                        ...
                        if (id == "")
                            voz("Se agrego correctamente");
                        else
                            voz("Se edito correctamente");
